  ...
  private getProductQLData(product: ProductModel, businessUuid: string): any {
    const productTmp = {
      ...
      sale: {
        ...
        saleEndDate: moment(product.saleEndDate, 'DD.MM.YYYY').format('YYYY-MM-DD'),
        saleStartDate: moment(product.saleStartDate, 'DD.MM.YYYY').format('YYYY-MM-DD'),
      },
      price: product.price,
      ...
      variants: (product.variants || []).map(variant => ({
        sale: {
          ...
          saleEndDate: moment(variant.saleEndDate, 'DD.MM.YYYY').format('YYYY-MM-DD'),
          saleStartDate: moment(variant.saleStartDate, 'DD.MM.YYYY').format('YYYY-MM-DD'),
        },
        ...omit(variant, [
          'lowInventory',
          'emailLowStock',
