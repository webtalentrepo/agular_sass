...
export class PeSubscriptionsThemesGuard implements CanActivate {
  constructor(
      ...
      .pipe(
        ...
        catchError(error => {
          const description = applicationId === BAD_REQUEST
            ? PeSubscriptionsRequestsErrorsEnum.NoApplicationId
            : PeSubscriptionsRequestsErrorsEnum.GetShopActiveTheme;
