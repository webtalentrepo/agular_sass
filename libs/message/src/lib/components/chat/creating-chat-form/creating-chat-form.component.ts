...
export class PeCreatingChatFormComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    this.setNextButtonText(null, 'create');
  }
  ...
  setNextButtonText(loading: boolean | null, sufix = 'done'): void {
    !loading && (this.title = this.translateService.translate(`message-app.${sufix === 'done'
