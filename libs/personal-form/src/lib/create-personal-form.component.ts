...
import { BehaviorSubject, interval, Observable, of, Subject, throwError, zip } from 'rxjs';
            ...
            .pipe(
              tap({
                next: () => {
                  ...
                  // }
                  this.eventOn.emit({ event: CreatePersonalFormEventType.UserIsCreated, data: this.type });
                },
                error: this.handleErrors,
              }),
            );
